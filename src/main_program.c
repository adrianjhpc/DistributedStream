...
#pragma omp parallel default(shared)
	...
	bandwidth_avg = ((1.0E-06 * copy_size)/node_results.Copy.avg) * node_comm.size;
	bandwidth_max = ((1.0E-06 * copy_size)/node_results.Copy.min) * node_comm.size;
	bandwidth_min = ((1.0E-06 * copy_size)/node_results.Copy.max) * node_comm.size;
	...
	// Calculate the node bandwidths.
	bandwidth_avg = ((1.0E-06 * scale_size)/node_results.Scale.avg) * node_comm.size;
	bandwidth_max = ((1.0E-06 * scale_size)/node_results.Scale.min) * node_comm.size;
	bandwidth_min = ((1.0E-06 * scale_size)/node_results.Scale.max) * node_comm.size;
	...
	// Calculate the node bandwidths.
	bandwidth_avg = ((1.0E-06 * add_size)/node_results.Add.avg) * node_comm.size;
	bandwidth_max = ((1.0E-06 * add_size)/node_results.Add.min) * node_comm.size;
	bandwidth_min = ((1.0E-06 * add_size)/node_results.Add.max) * node_comm.size;
	...
	// Calculate the node bandwidths.
	bandwidth_avg = ((1.0E-06 * triad_size)/node_results.Triad.avg) * node_comm.size;
